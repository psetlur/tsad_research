...
# randomly select configs from the grid for platform anomaly - trial 2
...
class Encoder(pl.LightningModule):
    ...
    #         # meta_0.append(m)
    #
    #         # inject platform anomaly
    #         m0 = [fixed_config_from_grid(CDF_LEVEL, GRID_LEVEL), np.random.uniform(0, 0.5),
    #               fixed_config_from_grid(CDF_LENGTH, GRID_LENGTH)]
    #         y_0[i][0] = self.inject_platform(y_0[i][0], *m0)
    #         meta_0.append(m0)
    #
